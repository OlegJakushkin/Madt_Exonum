...
${path_to_app} finalize --public-api-address 0.0.0.0:${public_port} --private-api-address 0.0.0.0:${private_port} ${node}/sec.toml ${node}/node.toml --public-configs {1,2,3,4}/pub.toml
