...
${path_to_app} generate-template common.toml --validators-count ${node}
...
${path_to_app} finalize --public-api-address 0.0.0.0:${public_port} --private-api-address 0.0.0.0:${private_port} ${node}/sec.toml ${node}/node.toml --public-configs ${node}/pub.toml
